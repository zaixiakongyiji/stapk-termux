...
import com.stapk.termux.app.settings.properties.TermuxAppSharedProperties;
import com.stapk.termux.app.terminal.TermuxTerminalSessionClient;
import com.stapk.termux.app.utils.PluginUtils;
import com.stapk.termux.shared.data.IntentUtils;
import com.stapk.termux.shared.models.errors.Errno;
import com.stapk.termux.shared.shell.ShellUtils;
import com.stapk.termux.shared.shell.TermuxShellEnvironmentClient;
import com.stapk.termux.shared.shell.TermuxShellUtils;
import com.stapk.termux.shared.termux.TermuxConstants;
import com.stapk.termux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
...
import com.stapk.termux.shared.shell.TermuxSession;
import com.stapk.termux.shared.terminal.TermuxTerminalSessionClientBase;
import com.stapk.termux.shared.logger.Logger;
import com.stapk.termux.shared.notification.NotificationUtils;
import com.stapk.termux.shared.packages.PermissionUtils;
import com.stapk.termux.shared.data.DataUtils;
import com.stapk.termux.shared.models.ExecutionCommand;
import com.stapk.termux.shared.shell.TermuxTask;
import com.stapk.termux.terminal.TerminalEmulator;
import com.stapk.termux.terminal.TerminalSession;
import com.stapk.termux.terminal.TerminalSessionClient;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.stapk.termux.shared.R.string.error_execution_cancelled))) {
