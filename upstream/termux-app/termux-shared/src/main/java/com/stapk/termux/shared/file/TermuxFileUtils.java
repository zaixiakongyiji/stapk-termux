package com.stapk.termux.shared.file;
...
import com.stapk.termux.shared.models.errors.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/com.stapk.termux` as secondary user will result
     * in `ls: /data/user/0/com.stapk.termux: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.stapk.termux` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.stapk.termux` where `10` is
