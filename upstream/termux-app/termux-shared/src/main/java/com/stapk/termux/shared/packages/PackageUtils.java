package com.stapk.termux.shared.packages;
...
import com.stapk.termux.shared.reflection.ReflectionUtils;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context) {
        try {
            ...
            * W/PackageManager: Failed to parse /path/to/com.stapk.termux.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.stapk.termux/10xxx}
            */
