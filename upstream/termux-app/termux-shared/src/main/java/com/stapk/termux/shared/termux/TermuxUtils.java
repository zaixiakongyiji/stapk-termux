...
import com.stapk.termux.shared.R;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.stapk.termux`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.stapk.termux/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.stapk.termux" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.stapk.termux.shared.R.raw.apt_info_script);
        try {
