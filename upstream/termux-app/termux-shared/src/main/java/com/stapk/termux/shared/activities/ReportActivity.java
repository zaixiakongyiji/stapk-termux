package com.stapk.termux.shared.activities;
...
import com.stapk.termux.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.stapk.termux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.stapk.termux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
