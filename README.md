...
[下载 v0.3.0-beta.1](https://github.com/zaixiakongyiji/stapk-termux/releases/tag/v0.3.0-beta.1) · [查看更新日志](CHANGELOG.md) · [查看设计文档](docs/superpowers/specs/2026-07-09-stapk-no-node-native-adapter-design.md)
...
> `v0.3.0-beta.1` 是首个公开 no-node 测试版，按全新安装交付。0.2.x 数据不会自动迁移，请在替换旧版本前先导出需要保留的数据。
...
前往 [Releases](https://github.com/zaixiakongyiji/stapk-termux/releases) 页面下载 APK。当前公开测试版为 [v0.3.0-beta.1](https://github.com/zaixiakongyiji/stapk-termux/releases/tag/v0.3.0-beta.1)。

| 要求 | 说明 |
|------|------|
| Android 版本 | 7.0+ (API 24+) |
| APK 类型 | 通用 APK；不包含 native runtime，不按 CPU ABI 拆包 |
| 安装方式 | 0.3.0 beta 建议全新安装，暂不自动迁移 0.2.x 数据 |
| 存储空间 | beta.1 APK 约 23 MB，另需保存角色、聊天、扩展和媒体数据的空间 |
...
git tag -a v0.3.0-beta.2 -m "release: 发布 stAPK 0.3.0 beta.2"
